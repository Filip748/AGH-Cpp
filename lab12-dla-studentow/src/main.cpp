// 18.12.2025
// CWL 12
// Laboratorium Język C++ - Zajęcia 12
//
//Polecenie
// Prosze napisać kod, który będzie implementował system Questów w oparciu o dostarczony (wybrakowany) kod biblioteki statycznej. 
//
