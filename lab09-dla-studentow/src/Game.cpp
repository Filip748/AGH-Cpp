...
{
    std::cout << "\n=== EPIZOD 1 ===\n";
    std::cout << "Zadanie: Stworzyć postać, miecz i dodać go do ekwipunku.\n";

#ifdef DEBUG
    std::cout << "[DEBUG][Game] Wyświetlam statystyki gracza...\n";
#endif

    player.showStats();

#ifdef DEBUG
    std::cout << "[DEBUG][Game] Tworzę miecz...\n";
#endif

    Item sword("Miecz Rycerski", 15, 50);

#ifdef DEBUG
    std::cout << "[DEBUG][Game] Dodaję miecz do ekwipunku...\n";
#endif
